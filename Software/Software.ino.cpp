# 1 "C:\\Users\\hilo9\\AppData\\Local\\Temp\\tmplakeyb21"
#include <Arduino.h>
...
#endif
#ifdef MODBUS_API
#include "src/communication/modbus_api/modbus_api.h"
#endif
#endif
...
#endif
#ifdef MODBUS_API
TaskHandle_t modbus_api_loop_task;
#endif
...
#line 84 "C:/Users/hilo9/Documents/GitHub/Battery-Emulator/Software/Software.ino"
void setup() {
  init_serial();
  ...
  init_modbus_api();
  xTaskCreatePinnedToCore((TaskFunction_t)&modbus_api_loop, "modbus_api_loop", 4096, NULL, TASK_MQTT_PRIO, &modbus_api_loop_task,
                          WIFI_CORE);
#endif
...
# 494 "C:/Users/hilo9/Documents/GitHub/Battery-Emulator/Software/Software.ino"
